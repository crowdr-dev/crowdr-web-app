            ...
            <div className="max-w-[346px]">
                <div id="upload" className="flex flex-col items-center rounded-lg border-[2px] border-dashed border-[#e4e7ec] py-4 px-6 mb-[20px]">
                  ...
                  <div className="text-center">
                    ...
                    <input type="text" id="upload" name="upload" placeholder="Enter your organization’s CAC number" className="text-[15px] rounded-lg border border-[#D0D5DD] py-[10px] px-[14px]" /> */}
                </div>

                <div id="cac_number" className="flex flex-col mb-[26px]">
                    <label htmlFor="cac_number" className="text-[14px] text-[#344054] mb-[6px]">CAC number</label>
                    <input type="text" id="cac_number" name="cac_number" placeholder="Enter your organization’s CAC number" className="text-[15px] rounded-lg border border-[#D0D5DD] py-[10px] px-[14px]" />
                </div>
                ...
                <div id="public_url" className="flex flex-col mb-[40px]">
                    ...
                    <div className="grid grid-cols-[146px_minmax(0,_1fr)]">
                      ...
                      <input type="text" id="public_url" name="public_url" className="text-[15px] rounded-tr-lg rounded-br-lg border border-[#D0D5DD] py-[10px] px-[14px]" />
                    </div>
                </div>
