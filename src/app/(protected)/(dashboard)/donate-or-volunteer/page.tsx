    ...
    return (
        <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
                <div>
                    <h3 className="text-2xl text-black font-semibold">Donate or Volunteer</h3>
                </div>
            </div>
            <div className="grid grid-cols-2 gap-4 min-w-full">
                ...
                <div>
                    <div>
                        <span className={`text-sm p-3 ${tab === "donate" ? activeTabStyle : inActiveTabStyle}`} onClick={() => { setTab("donate") }}>Donate</span>
                        <span className={`text-sm p-3 ml-4 ${tab === "volunteer" ? activeTabStyle : inActiveTabStyle}`} onClick={() => { setTab("volunteer") }}>Volunteer</span>
                    </div>
                    <hr className="mt-[9px]" />

                    {
                        ...
                        <div className="mt-4">
                                ...
                                <div className="flex flex-col items-start w-full">
                                    <label className="text-[14px] text-[#344054] mb-[6px]">Tell us a bit about yourself and why you’re interested in this project!</label>
